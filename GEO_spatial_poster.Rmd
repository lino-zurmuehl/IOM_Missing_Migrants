...
library(ggplot2)
library(ggrepel)
library(ggalt)  # For curved lines
...
countries <- gisco_get_countries(
  ...
  cache_dir = NULL,
  verbose = FALSE,
  resolution = "60",  # Lower resolution for cleaner background
  spatialtype = "RG",
  country = NULL,
  region = NULL
)
...
# Format: origin country, destination country, volume (arbitrary units for thickness)
